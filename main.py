...
def main():
    ...
    print("\n" + "=" * 60)
    print("Test 4: Crypto — 2 hops, 30% taint")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("Test 5: Crypto — mixer passthrough, 20% taint")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("Test 6: Crypto — 3 hops, deep taint 17.5%")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("Test 7: Crypto — forward exposure 51%")
    print("=" * 60)
